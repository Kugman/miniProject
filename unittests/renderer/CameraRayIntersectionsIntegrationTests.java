...
public class CameraRayIntersectionsIntegrationTests {
    ...
    private void countIntersections(Camera cam, Intersectable geometry, int expectedAns) {
        int counter = 0;
